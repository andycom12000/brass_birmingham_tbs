...
| 資源 Token | Custom Model (3D) | 大量 | 煤炭球 / 鐵礦方塊 / 啤酒桶 |
| 卡牌 | Deck / Card | ~60 | 地點卡 / 產業卡 / 萬用卡 |
| 金錢 | Custom Model (3D) | 大量 | £1 銅幣 / £5 銀幣 / £15 金幣 |
| 商人 Tiles | Custom Tile (2D) | ~12 | 依人數隨機設置 |
...
### 卡牌
- 地點卡（Location）、產業卡（Industry）、萬用卡（Wild）
